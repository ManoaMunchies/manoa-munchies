...
const EditVendorItemAdmin = () => {
  ...
  const submit = (data) => {
    const { name, location, hours, owner } = data;
    Vendors.collection.update(_id, { $set: { name, location, hours, owner } }, (error) => (error ?
  ...
  return ready ? (
    <Container className="py-3">
      ...
      <Row className="justify-content-center mt-3">
        <Col md="auto">
          <Button as="a" href="/vendors-admin" className="vendor-btn-edit">Back</Button>
        </Col>
      </Row>
    </Container>
  ) : <LoadingSpinner />;
